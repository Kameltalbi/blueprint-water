  ...
  return (
    <section className="landing-hero bg-card">
      ...
      <motion.div
        initial="hidden"
        animate="visible"
        className="relative z-10 mx-auto max-w-[1200px] grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-[5%]"
      >
        {/* ── Left: Text ── */}
        <div className="flex flex-col items-start text-left">
          ...
          <motion.h1
            custom={1}
            variants={fadeUp}
            className="font-display text-[clamp(2.4rem,5vw,4.2rem)] font-extrabold leading-[1.1] text-foreground mb-5"
          >
          ...
          <motion.p custom={2} variants={fadeUp} className="max-w-[520px] text-lg text-muted-foreground mb-10">
            {fr
          ...
          <motion.div custom={3} variants={fadeUp} className="flex gap-4 flex-wrap">
            ...
            <a href="#fonctionnalites" className="inline-flex items-center rounded-[10px] px-8 py-3.5 font-medium text-white hover:opacity-90 transition-all" style={{ backgroundColor: '#015486' }}>
        ...
        {/* ── Right: Illustration ── */}
        <motion.div custom={2} variants={fadeUp} className="flex justify-center lg:justify-end">
          <img
      ...
      >
        <motion.div custom={5} variants={fadeUp} className="landing-stats w-full max-w-3xl mx-auto">
          {stats.map((s, i) => (
