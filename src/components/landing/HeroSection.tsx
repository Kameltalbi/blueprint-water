    ...
    <section className="landing-hero bg-card">
      ...
      >
        ...
        <motion.div custom={3} variants={fadeUp} className="flex gap-4 flex-wrap justify-center">
          <a href="#calculateur" className="inline-flex items-center gap-2 rounded-[10px] px-8 py-3.5 font-semibold text-primary-foreground gradient-water shadow-[0_4px_20px_hsl(var(--ocean)/0.25)] hover:shadow-[0_8px_30px_hsl(var(--ocean)/0.35)] hover:-translate-y-0.5 transition-all">
