  ...
  return (
    <AbsoluteFill style={{
      ...
      <div style={{
        ...
        transform: `scale(${logoScale}) translateY(${float}px)`, marginBottom: 30,
      }}>
      ...
      <div style={{
        ...
        fontSize: 64, fontWeight: 800, color: "white", textAlign: "center",
      ...
      <div style={{
        ...
        marginTop: 40, fontSize: 22, color: "rgba(255,255,255,0.8)",
